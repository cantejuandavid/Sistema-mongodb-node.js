...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var input = '<input type="search" placeholder="Buscar" class="form-control input-sm'+classes.sFilterInput+'"/>';
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfo": "Viendo _START_ - _END_ de _TOTAL_ entradas",
			 ...
			 *    } );
			 */
			"sInfoEmpty": "Viendo 0 - 0 de 0 entradas",
			 ...
			 *    } );
			 */
			"sInfoFiltered": "(filtrado entre _MAX_ entradas)",
